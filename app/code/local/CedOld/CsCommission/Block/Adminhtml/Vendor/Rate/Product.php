...
class Ced_CsCommission_Block_Adminhtml_Vendor_Rate_Product extends Mage_Adminhtml_Block_System_Config_Form_Field_Array_Abstract
{
     ...
     */
	protected function _getProductTypesRenderer()
    {
        if (!$this->_actionRenderer) {
            $this->_actionRenderer = $this->getLayout()->createBlock(
                'cscommission/adminhtml_vendor_rate_product_type', '',
    ...
    {
        $this->addColumn('types', array(
            'label' => Mage::helper('cscommission')->__('Product Types'),
