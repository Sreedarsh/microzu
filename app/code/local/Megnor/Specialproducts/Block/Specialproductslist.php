<?php class Megnor_Specialproducts_Block_Specialproductslist extends Mage_Catalog_Block_Product_Abstract
{
    ...
    protected function _beforeToHtml()
    {
		...
		$toolbar->setDefaultOrder('news_from_date')->setDefaultDirection('desc')->setCollection($collection);		
		return $this;        
    }
	...
	public function getHeading() {
		return Mage::getStoreConfig('specialproducts/listing_home/heading');
    }
		
	public function getPageHeading() {
		return Mage::getStoreConfig('specialproducts/standalone/heading');
    }
